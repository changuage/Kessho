...

{
  ...
  if (!fetchLatestV2Body) {
    ...
    if (fetchLatestV2Body.includes('await readPresetPayloadCacheV2')) {
      fail(filePath, findLine(text, 'fetchPresetByIdLatestV2Rpc'), 'latest V2 share/open path must read payload cache synchronously');
    }
  }
