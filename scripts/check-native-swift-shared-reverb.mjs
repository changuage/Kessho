...
const packageManifest = read('KesshoNativeSwift/Package.swift');
const dspHeader = read('KesshoNativeSwift/NativeDSP/include/KesshoDSP/KesshoDSP.h');
const nativeBridge = read('KesshoNativeSwift/NativeDSP/kessho_reverb_unified.cpp');
const nativeWrapper = read('KesshoNativeSwift/Kessho/Audio/ReverbNativeDSP.swift');
const nativeProcessor = read('KesshoNativeSwift/Kessho/Audio/ReverbProcessor.swift');
