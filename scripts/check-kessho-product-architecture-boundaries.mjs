...
const focusedHeaders = [
  ['cpp/KesshoCore/src/product/ProductConstants.h', 250],
  ['cpp/KesshoCore/src/product/ProductDynamicsConstants.h', 120],
  ['cpp/KesshoCore/src/product/ProductDynamicsRouteConstants.h', 100],
  ...
  ['cpp/KesshoCore/src/product/ProductGranularState.h', 80],
  ['cpp/KesshoCore/src/product/ProductFxRoutingGraphState.h', 150],
  ...
  ['cpp/KesshoCore/src/product/ProductState.h', 640],
];
...
const secondStageCaps = [
  ...
  ['cpp/KesshoCore/src/product/sources/ProductSources.cpp', 145],
  ['cpp/KesshoCore/src/product/sources/SourceTargets.cpp', 120],
  ['cpp/KesshoCore/src/product/sources/SourcePresetEvents.cpp', 140],
  ['cpp/KesshoCore/src/product/sources/SourcePresetEndpointOverrides.cpp', 80],
  ...
  ['cpp/KesshoCore/src/product/sources/SourceTransientAudition.cpp', 100],
  ['cpp/KesshoCore/src/product/sources/SourceGraphTaps.cpp', 140],
  ['cpp/KesshoCore/src/product/sources/SourceMix.cpp', 135],
  ['cpp/KesshoCore/src/product/sources/SourceModulation.cpp', 320],
  ['cpp/KesshoCore/src/product/sources/SourceModulationRoutes.cpp', 220],
  ['cpp/KesshoCore/src/product/sources/SourceModulationRuntime.cpp', 360],
  ...
  ['cpp/KesshoCore/src/product/sources/SourceVoiceAllocator.cpp', 380],
  ...
  ['cpp/KesshoCore/src/product/sources/SourceVoiceKill.cpp', 80],
  ['cpp/KesshoCore/src/product/sources/SourceVoiceRelease.cpp', 60],
  ['cpp/KesshoCore/src/product/sources/SoundscapeTransportRuntime.cpp', 80],
  ...
  ['cpp/KesshoCore/src/product/fx/ProductReverbModuleConfig.cpp', 80],
  ['cpp/KesshoCore/src/product/fx/ProductReverbPreconditioner.cpp', 120],
  ['cpp/KesshoCore/src/product/fx/ProductReverb.cpp', 220],
  ['cpp/KesshoCore/src/product/fx/ProductGranular.cpp', 180],
  ['cpp/KesshoCore/src/product/fx/ProductGranularRuntime.cpp', 120],
  ['cpp/KesshoCore/src/product/fx/ProductGranularPhraseRuntime.cpp', 60],
  ['cpp/KesshoCore/src/product/fx/ProductSpectralFreeze.cpp', 80],
  ['cpp/KesshoCore/src/product/fx/ProductFxGraph.cpp', 190],
  ['cpp/KesshoCore/src/product/fx/ProductFxGraphRouting.cpp', 140],
  ['cpp/KesshoCore/src/product/fx/ProductFxRouteModulation.cpp', 80],
  ['cpp/KesshoCore/src/product/fx/ProductDynamics.cpp', 80],
  ['cpp/KesshoCore/src/product/fx/ProductDynamicsSidechain.cpp', 240],
  ['cpp/KesshoCore/src/product/fx/ProductDynamicsRouting.cpp', 200],
  ['cpp/KesshoCore/src/product/fx/ProductDynamicsTerminal.cpp', 320],
  ['cpp/KesshoCore/src/product/fx/ProductDynamicsRender.cpp', 80],
];
...
const allocationFreeHotPathFiles = [
  ...
  'cpp/KesshoCore/src/product/sources/SourceVoiceKill.cpp',
  'cpp/KesshoCore/src/product/sources/SourceVoiceRelease.cpp',
  'cpp/KesshoCore/src/product/sources/SoundscapeTransportRuntime.cpp',
  ...
  'cpp/KesshoCore/src/product/fx/ProductReverbModuleConfig.cpp',
  'cpp/KesshoCore/src/product/fx/ProductReverbPreconditioner.cpp',
  ...
  'cpp/KesshoCore/src/product/fx/ProductDynamicsRouting.cpp',
  'cpp/KesshoCore/src/product/fx/ProductDynamicsTerminal.cpp',
  'cpp/KesshoCore/src/product/fx/ProductDynamicsRender.cpp',
...
const focusedSourceContracts = [
  ...
  ['cpp/KesshoCore/src/product/sources/SourceVoiceKill.cpp', ['KesshoProductEngine::killSourceVoices(']],
  ['cpp/KesshoCore/src/product/sources/SourceVoiceRelease.cpp', ['KesshoProductEngine::releaseSourceVoices(']],
  ['cpp/KesshoCore/src/product/sources/SoundscapeTransportRuntime.cpp', ['KesshoProductEngine::stopSoundscapeTransportRuntime(']],
...
const focusedFxContracts = [
  ...
  ['cpp/KesshoCore/src/product/fx/ProductReverbModuleConfig.cpp', ['KesshoProductEngine::configureReverbModule(']],
  [
    'cpp/KesshoCore/src/product/fx/ProductDynamicsConfig.cpp',
    ['KesshoProductEngine::configureDynamicsDriftModule('],
  ],
  ['cpp/KesshoCore/src/product/fx/ProductDynamicsModRoutes.cpp', ['KesshoProductEngine::dynamicsModRoute(']],
  ...
  [
    ...
    [
      ...
      'KesshoProductEngine::renderGranular(',
    ],
  ],
  [
    'cpp/KesshoCore/src/product/fx/ProductGranularRuntime.cpp',
  ...
  ['cpp/KesshoCore/src/product/fx/ProductDynamicsRouting.cpp', ['KesshoProductEngine::mixFxBuffer(']],
  ['cpp/KesshoCore/src/product/fx/ProductDynamicsRender.cpp', ['KesshoProductEngine::renderDynamics(']],
];
