...
const classifiedRuntimeAllowlist = new Map([
  ...
  ['./product/native/MacNativeProductRuntime', 'native Product runtime lifecycle and telemetry bridge'],
  ...
  ['./productInteractionEventStore', 'Product interaction event publication store'],
  ['./productInteractionSignalStore', 'Product interaction signal publication store'],
  ['./productInteractionVocabulary', 'Product interaction ABI vocabulary and types'],
