...
const classifiedRuntimeAllowlist = new Map([
  ...
  ['./coreProductArrangementPadChord', 'product arrangement pad-chord event builder'],
  ...
  ['./coreProductChordSequencerClock', 'product chord sequencer clock helper'],
  ...
  ['./synthChordSequencer', 'product synth chord sequencer config and resolution helper'],
