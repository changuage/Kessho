...
const productWorkletEventNames = [
  ...
  'SetAutoStop',
  'SetScatterVoiceParam',
  'CommitScatterConfig',
  'SetScatterEnabled',
  'BeginSceneProgram',
  'SetSceneEntry',
  'SetSceneCommandHeader',
  'SetSceneCommandValues',
  'CommitSceneProgram',
  'SetScenePosition',
  'BeginRoutingMuteGroups',
  'SetRoutingMuteGroupSlot',
  'CommitRoutingMuteGroups',
  'RecallRoutingMuteGroup',
  'SetRoutingMuteGroupsEnabled',
  'ConfigureGlobalAutoCycle',
  'BeginJourneySchedule',
  'SetJourneyScheduleEntryHold',
  'SetJourneyScheduleEntryMorph',
  'BeginJourneyTransitionProgram',
  'SetJourneyTransitionEntry',
  'SetJourneyTransitionCommandHeader',
  'SetJourneyTransitionCommandValues',
  'CommitJourneyTransitionProgram',
  'CommitJourneySchedule',
  'SetJourneyScheduleEnabled',
];
