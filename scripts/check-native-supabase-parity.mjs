...
const nativeService = read('KesshoiOS/Kessho/Services/SupabaseService.swift');
const appState = read('KesshoiOS/Kessho/State/AppState.swift');
const presetList = read('KesshoiOS/Kessho/Views/PresetListView.swift');
const sliderState = read('KesshoiOS/Kessho/State/SliderState.swift');
const infoPlist = read('KesshoiOS/Kessho/Info.plist');
const packageSwift = read('KesshoiOS/Package.swift');
