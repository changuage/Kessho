...
int main() {
  ...
  static_assert(sizeof(KesshoProductSnapshotV2) == 153044, "product snapshot ABI size changed");
  ...
  require(offsetof(KesshoProductSnapshotV2, sonic_runtime) == 152868, "snapshot sonic runtime offset changed");
