...
int main() {
  ...
  static_assert(sizeof(KesshoProductSnapshotV2) == 151444, "product snapshot ABI size changed");
  ...
  static_assert(sizeof(KesshoProductTelemetry) == 15048, "product telemetry ABI size changed");
  ...
  require(
      offsetof(KesshoProductTelemetry, earth_texture_asset_ids) == 1296,
      "telemetry Earth texture debug offset changed");
  require(
      offsetof(KesshoProductTelemetry, modulation_debug_count) == 1584,
      "telemetry modulation debug offset changed");
  require(
      offsetof(KesshoProductTelemetry, modulation_debug_last_trigger_frames) == 6968,
  ...
  require(
      offsetof(KesshoProductTelemetry, debug_source_state_count) == 8764,
      "telemetry debug source count offset changed");
  require(
      offsetof(KesshoProductTelemetry, debug_source_states) == 8768,
      "telemetry debug source states offset changed");
  require(
      offsetof(KesshoProductTelemetry, debug_voice_spawn_count) == 9024,
      "telemetry debug voice count offset changed");
  require(
      offsetof(KesshoProductTelemetry, debug_voice_spawns) == 9032,
      "telemetry debug voice spawns offset changed");
  require(
      offsetof(KesshoProductTelemetry, synth_orbit_visual_note_counts) == 9800,
      "telemetry synth Orbit visual note-count offset changed");
  require(
      offsetof(KesshoProductTelemetry, synth_orbit_visual_base_angles) == 9864,
      "telemetry synth Orbit visual base-angle offset changed");
  require(
      offsetof(KesshoProductTelemetry, synth_orbit_visual_note_angles) == 9928,
      "telemetry synth Orbit visual note-angle offset changed");
  require(
      offsetof(KesshoProductTelemetry, synth_orbit_visual_note_flashes) == 11976,
      "telemetry synth Orbit visual note-flash offset changed");
  require(
      offsetof(KesshoProductTelemetry, synth_anchor_walker_visual_flags) == 14024,
      "telemetry synth Anchor Walker visual flags offset changed");
  require(
      offsetof(KesshoProductTelemetry, synth_anchor_walker_cursor_degrees) == 14088,
      "telemetry synth Anchor Walker cursor-degree offset changed");
  require(
      offsetof(KesshoProductTelemetry, synth_anchor_walker_last_gesture_deltas) == 14152,
      "telemetry synth Anchor Walker gesture-delta offset changed");
  require(
      offsetof(KesshoProductTelemetry, synth_anchor_walker_boundary_events) == 14216,
      "telemetry synth Anchor Walker boundary-event offset changed");
  require(
      offsetof(KesshoProductTelemetry, synth_anchor_walker_output_counts) == 14280,
      "telemetry synth Anchor Walker output-count offset changed");
  require(
      offsetof(KesshoProductTelemetry, synth_anchor_walker_anchor_midis) == 14344,
      "telemetry synth Anchor Walker anchor-MIDI offset changed");
  require(
      offsetof(KesshoProductTelemetry, synth_anchor_walker_cursor_midis) == 14408,
      "telemetry synth Anchor Walker cursor-MIDI offset changed");
  require(
      offsetof(KesshoProductTelemetry, synth_anchor_walker_previous_cursor_midis) == 14472,
      "telemetry synth Anchor Walker previous-cursor-MIDI offset changed");
  require(
      offsetof(KesshoProductTelemetry, synth_anchor_walker_output_midis) == 14536,
      "telemetry synth Anchor Walker output-MIDI offset changed");
  require(
      offsetof(KesshoProductTelemetry, synth_anchor_walker_output_velocities) == 14792,
