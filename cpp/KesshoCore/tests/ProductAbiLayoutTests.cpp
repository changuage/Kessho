...
int main() {
  static_assert(sizeof(KesshoProductSourceSnapshot) == 3336, "source snapshot ABI size changed");
  static_assert(sizeof(KesshoProductSequencerLaneSnapshot) == 92, "sequencer lane snapshot ABI size changed");
  static_assert(sizeof(KesshoProductSnapshotV2) == 29100, "product snapshot ABI size changed");
