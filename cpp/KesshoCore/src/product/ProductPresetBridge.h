...
inline kessho::core::KesshoSourcePresetPatch morphSourcePresetPatch(
  ...
  kessho::core::KesshoSourcePresetPatch patch{};
  patch.tone = lerpPresetValue(a.tone, b.tone, t);
  patch.brightness = lerpPresetValue(a.brightness, b.brightness, t);
  patch.texture = lerpPresetValue(a.texture, b.texture, t);
  patch.motion = lerpPresetValue(a.motion, b.motion, t);
  patch.attack = lerpPresetValue(a.attack, b.attack, t);
  patch.release = lerpPresetValue(a.release, b.release, t);
  patch.body = lerpPresetValue(a.body, b.body, t);
  patch.transient = lerpPresetValue(a.transient, b.transient, t);
