...
#include "ProductGranularState.h"
#include "ProductRoutingState.h"
...
struct FxState {
  ...
  uint32_t spectral_freeze_mode = 2u;
  uint32_t spectral_freeze_capture_serial = 0u;
  float spectral_freeze_stretch_speed = 0.5f;
  uint32_t spectral_freeze_direction = 2u;
  float spectral_freeze_position = 0.0f;
  float spectral_freeze_refresh = 0.15f;
  float spectral_freeze_input_sensitivity = 0.5f;
  float spectral_freeze_diffusion = 0.55f;
  float spectral_freeze_tone = -0.15f;
  float spectral_freeze_width = 0.85f;
  float spectral_freeze_sustain = 1.0f;
