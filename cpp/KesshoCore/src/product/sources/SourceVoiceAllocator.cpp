...
uint32_t KesshoProductEngine::triggerVoice(
  ...
  source.spectral_freeze_send = resolveModulatedValue(source_id, KESSHO_PRODUCT_PARAM_SOURCE_SPECTRAL_FREEZE_SEND_ID, source.spectral_freeze_send, resolved_seed);
  if (source_was_idle) {
