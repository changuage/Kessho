  ...
  const auto taps = [this, source_id]() -> SourceGraphTapPointers {
    switch (source_id) {
      ...
      case KESSHO_PRODUCT_SOURCE_SAMPLE2:
        return {graph_sample2_dry_l, graph_sample2_dry_r, graph_sample2_reverb_send_l, graph_sample2_reverb_send_r,
            graph_sample2_delay_a_send_l, graph_sample2_delay_a_send_r, graph_sample2_delay_b_send_l, graph_sample2_delay_b_send_r,
            graph_sample2_granular_send_l, graph_sample2_granular_send_r, graph_sample2_diffuse_send_l, graph_sample2_diffuse_send_r};
      default:
        return {};
    }
  }();
