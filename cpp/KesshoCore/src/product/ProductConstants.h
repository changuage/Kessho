...
constexpr uint32_t kPadVoiceSeedMask = 0x0f000000u;
constexpr uint32_t kPadVoiceSeedShift = 24u;
constexpr uint32_t kPadVoiceSeedPayloadMask = 0x00ffffffu;
constexpr uint32_t kPadVoiceMaskSeedFlag = 0x20000000u;
constexpr uint32_t kPadVoiceMaskSeedMask = 0x00ff0000u;
constexpr uint32_t kPadVoiceMaskSeedShift = 16u;
constexpr uint32_t kPadVoiceMaskSeedPayloadMask = 0x0000ffffu;
