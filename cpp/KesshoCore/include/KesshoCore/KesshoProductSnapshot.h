...
typedef struct KesshoProductHarmonySnapshot {
  ...
  uint32_t harmony_slot_playback_behavior[8];
  uint32_t harmony_slot_intent_present[8];
  uint32_t harmony_slot_intent_quality[8];
  uint32_t harmony_slot_intent_root_mode[8];
  int32_t harmony_slot_intent_degree[8];
  float harmony_slot_intent_root_note[8];
  int32_t harmony_slot_intent_inversion[8];
  float harmony_slot_intent_spread[8];
  int32_t harmony_slot_intent_octave[8];
  uint32_t harmony_slot_intent_bass_mode[8];
  float harmony_slot_intent_bass_note[8];
  uint32_t harmony_slot_intent_strength[8];
  uint32_t harmony_slot_intent_source[8];
  uint32_t harmony_slot_intent_extension_mask[8];
  uint32_t harmony_slot_intent_alteration_mask[8];
  float harmony_slot_captured_root_midi[8];
  uint32_t harmony_slot_captured_scale_id[8];
  uint32_t live_gesture_revision;
  uint32_t live_gesture_scope;
  uint32_t live_gesture_target;
  uint32_t live_gesture_phase;
  uint32_t live_gesture_playback_behavior;
  uint32_t live_gesture_intent_present;
  uint32_t live_gesture_intent_quality;
  uint32_t live_gesture_intent_root_mode;
  int32_t live_gesture_intent_degree;
  float live_gesture_intent_root_note;
  int32_t live_gesture_intent_inversion;
  float live_gesture_intent_spread;
  int32_t live_gesture_intent_octave;
  uint32_t live_gesture_intent_bass_mode;
  float live_gesture_intent_bass_note;
  uint32_t live_gesture_intent_extension_mask;
  uint32_t live_gesture_intent_alteration_mask;
  float live_gesture_captured_root_midi;
  uint32_t live_gesture_captured_scale_id;
  uint32_t live_gesture_note_count;
  float live_gesture_notes[8];
  uint32_t live_gesture_expires_at_frame_low;
  uint32_t live_gesture_expires_at_frame_high;
  uint32_t takeover_anchor_count;
  float takeover_anchor_source[12];
  float takeover_anchor_target[12];
  float takeover_anchor_weight[12];
  float takeover_target_root_midi;
  uint32_t takeover_target_scale_id;
  float takeover_progress;
  uint32_t morph_endpoint_count;
  float morph_endpoint_root_midi[2];
  uint32_t morph_endpoint_scale_id[2];
  float morph_endpoint_tension[2];
  uint32_t morph_plan_revision;
  float morph_plan_phase;
  uint32_t morph_plan_slot_playback_behavior[8];
  uint32_t morph_common_pair_count;
  float morph_common_pair_source[8];
  float morph_common_pair_target[8];
  uint32_t morph_voice_pair_count;
  float morph_voice_pair_source[8];
  float morph_voice_pair_target[8];
  uint32_t morph_unmatched_a_count;
  float morph_unmatched_a[8];
  uint32_t morph_unmatched_b_count;
  float morph_unmatched_b[8];
  uint32_t morph_cof_root_path_count;
  float morph_cof_root_path[13];
  uint32_t morph_scale_handover_from;
  uint32_t morph_scale_handover_to;
  float morph_scale_handover_at;
