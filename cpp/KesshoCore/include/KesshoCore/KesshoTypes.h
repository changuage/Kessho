...
#define KESSHO_MODULE_DELAY_A_OUTPUT_TAP_COUNT 5
#define KESSHO_MODULE_DELAY_B_OUTPUT_TAP_COUNT 5
...
typedef enum KesshoModuleType {
  KESSHO_MODULE_DYNAMICS_DRIFT = 1,
...
typedef enum KesshoModuleOutputTap {
  ...
  KESSHO_MODULE_DELAY_A_TAP_DRIFT_SEND = 4,
  ...
  KESSHO_MODULE_DELAY_B_TAP_DRIFT_SEND = 4
