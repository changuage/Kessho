...
- **Linked from**: `public/ARCHIVE/fm-modal-methodology-demo.html`, `public/ARCHIVE/fm-modal-demo.html`
...
| Preset | Character |
|--------|-----------|
| **Ocean Surf** | Pure surf, minimal drops — now replaces the retired Wave Synth path |
