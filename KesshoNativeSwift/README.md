...
A paused native Swift iOS/macOS prototype for Kessho.

The active product lane is Kessho Webapp plus Kessho Capacitor, both driven by
the shared Kessho Core C++/WASM backbone. Keep this Swift tree as a separate
reference target unless the product direction changes again.
