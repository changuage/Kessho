...
const project = read('KesshoNativeSwift/Kessho.xcodeproj/project.pbxproj');
const infoPlist = read('KesshoNativeSwift/Kessho/Info.plist');
const mainView = read('KesshoNativeSwift/Kessho/Views/MainView.swift');
const macComponents = read('KesshoNativeSwift/Kessho/Platform/KesshoMacComponents.swift');
