...
for (const file of [
  ...
  'KesshoNativeSwift/Kessho/Audio/SharedDelayProcessor.swift',
  'KesshoNativeSwift/Kessho/Audio/DynamicsCharacterProcessor.swift',
  'KesshoNativeSwift/Kessho/Audio/SpectralFreezeProcessor.swift',
]) {
  assertRenderUsesTryLock(file);
  assertSourceNodeUsesTryLock(file);
}

const drumSynth = read('KesshoNativeSwift/Kessho/Audio/DrumSynth.swift');
...
const dynamics = read('KesshoNativeSwift/Kessho/Audio/DynamicsCharacterProcessor.swift');
assert(
...
const reverb = read('KesshoNativeSwift/Kessho/Audio/ReverbProcessor.swift');
