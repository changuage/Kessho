...
class AppState: ObservableObject {
    ...
    private func updateSliderStateValue(_ state: inout SliderState, key: String, value: Double) {
        ...
        case "erosionMix": state.erosionMix = value
        case "erosionAge": state.erosionAge = value
        case "erosionGeneration": state.erosionGeneration = value
        case "erosionAlias": state.erosionAlias = value
        case "erosionWow": state.erosionWow = value
        case "erosionFlutter": state.erosionFlutter = value
        case "erosionDrift": state.erosionDrift = value
        case "erosionWobbleSpeed": state.erosionWobbleSpeed = value
        case "erosionTone": state.erosionTone = value
        case "degradeHp": state.degradeHp = value
        case "degradeLp": state.degradeLp = value
        case "erosionNoise": state.erosionNoise = value
        case "erosionSaturation": state.erosionSaturation = value
        case "erosionCorrosion": state.erosionCorrosion = value
    ...
    private func lerpPresets(_ a: SliderState, _ b: SliderState, t: Double) -> SliderState {
        ...
        result.erosionMix = lerp(a.erosionMix, b.erosionMix, t)
        result.erosionAge = lerp(a.erosionAge, b.erosionAge, t)
        result.erosionGeneration = lerp(a.erosionGeneration, b.erosionGeneration, t)
        result.erosionAlias = lerp(a.erosionAlias, b.erosionAlias, t)
        result.erosionWow = lerp(a.erosionWow, b.erosionWow, t)
        result.erosionFlutter = lerp(a.erosionFlutter, b.erosionFlutter, t)
        result.erosionDrift = lerp(a.erosionDrift, b.erosionDrift, t)
        result.erosionWobbleSpeed = lerp(a.erosionWobbleSpeed, b.erosionWobbleSpeed, t)
        result.erosionTone = lerp(a.erosionTone, b.erosionTone, t)
        result.degradeHp = lerp(a.degradeHp, b.degradeHp, t)
        result.degradeLp = lerp(a.degradeLp, b.degradeLp, t)
        result.erosionNoise = lerp(a.erosionNoise, b.erosionNoise, t)
        result.erosionSaturation = lerp(a.erosionSaturation, b.erosionSaturation, t)
        result.erosionCorrosion = lerp(a.erosionCorrosion, b.erosionCorrosion, t)
        ...
        if t >= 0.5 {
            ...
            result.erosionEnabled = b.erosionEnabled
