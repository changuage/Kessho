...
struct SnowflakeView: View {
    ...
    var showsMacroControls: Bool = true
    ...
    var body: some View {
        GeometryReader { geometry in
            ...
            ZStack {
                ...
                HexagonShape()
                    .fill(draggingCenter ? Color(red: 0.76, green: 0.58, blue: 0.04).opacity(0.25) : Color.white.opacity(showsMacroControls ? 0.05 : 0.72))
                    .overlay(
                        HexagonShape()
                            .stroke(
