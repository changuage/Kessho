# KesshoNativeSwift Overview

## Project Summary

This document describes the paused native Swift iOS/macOS port of the
**Generative Ambient Music** web application. It is preserved as a reference
target; the active product path is Kessho Webapp plus Kessho Capacitor on top of
the shared Kessho Core C++/WASM backbone.
