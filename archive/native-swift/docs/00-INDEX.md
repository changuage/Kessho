# KesshoNativeSwift Documentation Index

These docs describe the paused native Swift iOS/macOS port. The active product
lane is Kessho Webapp plus Kessho Capacitor, with shared audio work moving into
Kessho Core C++/WASM.
