...
$EXPORTS = @(
  ...
  '_pad_kill_voice','_pad_set_voice_pad','_pad_set_osc_a_wave','_pad_set_osc_a_position',
  '_pad_set_osc_a_phase_distortion','_pad_set_osc_a_pitch','_pad_set_osc_a_hz_offset','_pad_set_osc_a_level','_pad_set_osc_b_wave',
  '_pad_set_osc_b_position','_pad_set_osc_b_phase_distortion','_pad_set_osc_b_pitch','_pad_set_osc_b_hz_offset','_pad_set_osc_b_level',
  '_pad_set_osc_mix','_pad_set_drift','_pad_set_phase_reset','_pad_set_sub_enabled','_pad_set_sub_octave',
  ...
  '_pad_set_fold_mode','_pad_set_filter_type','_pad_set_filter_cutoff',
  '_pad_set_filter_resonance','_pad_set_filter_q','_pad_set_filter_slope','_pad_set_filter_key_tracking',
