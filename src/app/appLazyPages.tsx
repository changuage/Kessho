...
export const ReverbPage = React.lazy(() => import('../ui/reverb/ReverbPage'));
export const DrumPage = React.lazy(() => import('../ui/drums/DrumPage'));
export const GranularPage = React.lazy(() => import('../ui/granular/GranularPage'));
export const DelayPage = React.lazy(() => import('../ui/delay/DelayPage'));
