...
const LEAD_ALGORITHM_PARAM_INDEX = 0;
const LEAD_ATTACK_PARAM_INDEX = 43;
const LEAD_DECAY_PARAM_INDEX = 44;
const LEAD_SUSTAIN_PARAM_INDEX = 45;
const LEAD_RELEASE_PARAM_INDEX = 46;
const LEAD_FILTER_FREQ_PARAM_INDEX = 47;
const LEAD_FILTER_Q_PARAM_INDEX = 48;
const LEAD_FILTER_ENV_DEPTH_PARAM_INDEX = 54;
const LEAD_DRIVE_PARAM_INDEX = 55;
const LEAD_TRANSIENT_CLICK_PARAM_INDEX = 56;
const LEAD_TRANSIENT_NOISE_PARAM_INDEX = 57;
const LEAD_GAIN_PARAM_INDEX = 62;
const LEAD_CARRIER2_MIX_PARAM_INDEX = 2;
const LEAD_MOD1_INDEX_PARAM_INDEX = 4;
const LEAD_MOD2_INDEX_PARAM_INDEX = 14;
const LEAD_MOD3_INDEX_PARAM_INDEX = 24;
const LEAD_MOD4_INDEX_PARAM_INDEX = 34;
