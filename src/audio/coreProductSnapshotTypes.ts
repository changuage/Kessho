...
export type ProductHarmonySnapshot = L4HarmonyStateExtension & {
  ...
  notePoolMidi: number[];
  harmonySlotNoteCount?: number[];
  harmonySlotMidi?: number[];
  bassMidi: number;
  ...
  harmonySlotPlaybackBehavior?: number[];
  harmonySlotIntentPresent?: number[];
  harmonySlotIntentQuality?: number[];
  harmonySlotIntentRootMode?: number[];
  harmonySlotIntentDegree?: number[];
  harmonySlotIntentRootNote?: number[];
  harmonySlotIntentInversion?: number[];
  harmonySlotIntentSpread?: number[];
  harmonySlotIntentOctave?: number[];
  harmonySlotIntentBassMode?: number[];
  harmonySlotIntentBassNote?: number[];
  harmonySlotIntentStrength?: number[];
  harmonySlotIntentSource?: number[];
  harmonySlotIntentExtensionMask?: number[];
  harmonySlotIntentAlterationMask?: number[];
  harmonySlotCapturedRootMidi?: number[];
  harmonySlotCapturedScaleId?: number[];
  liveGestureRevision?: number;
  liveGestureScope?: number;
  liveGestureTarget?: number;
  liveGesturePhase?: number;
  liveGesturePlaybackBehavior?: number;
  liveGestureIntentPresent?: number;
  liveGestureIntentQuality?: number;
  liveGestureIntentRootMode?: number;
  liveGestureIntentDegree?: number;
  liveGestureIntentRootNote?: number;
  liveGestureIntentInversion?: number;
  liveGestureIntentSpread?: number;
  liveGestureIntentOctave?: number;
  liveGestureIntentBassMode?: number;
  liveGestureIntentBassNote?: number;
  liveGestureIntentExtensionMask?: number;
  liveGestureIntentAlterationMask?: number;
  liveGestureCapturedRootMidi?: number;
  liveGestureCapturedScaleId?: number;
  liveGestureNoteCount?: number;
  liveGestureNotes?: number[];
  liveGestureExpiresAtFrame?: number;
  takeoverAnchorCount?: number;
  takeoverAnchorSource?: number[];
  takeoverAnchorTarget?: number[];
  takeoverAnchorWeight?: number[];
  takeoverTargetRootMidi?: number;
  takeoverTargetScaleId?: number;
  takeoverProgress?: number;
  morphEndpointCount?: number;
  morphEndpointRootMidi?: number[];
  morphEndpointScaleId?: number[];
  morphEndpointTension?: number[];
  morphPlanRevision?: number;
  morphPlanPhase?: number;
  morphPlanSlotPlaybackBehavior?: number[];
  morphCommonPairCount?: number;
  morphCommonPairSource?: number[];
  morphCommonPairTarget?: number[];
  morphVoicePairCount?: number;
  morphVoicePairSource?: number[];
  morphVoicePairTarget?: number[];
  morphUnmatchedACount?: number;
  morphUnmatchedA?: number[];
  morphUnmatchedBCount?: number;
  morphUnmatchedB?: number[];
  morphCofRootPathCount?: number;
  morphCofRootPath?: number[];
  morphScaleHandoverFrom?: number;
  morphScaleHandoverTo?: number;
  morphScaleHandoverAt?: number;
};
