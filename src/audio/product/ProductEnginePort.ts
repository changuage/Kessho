...
import type { ProductEngineJourneyPort } from './ports/ProductJourneyPort';
...
export type { ProductEngineJourneyPort, ProductBackgroundJourneyReadiness } from './ports/ProductJourneyPort';
