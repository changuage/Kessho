...
const RANGE_KEY_TARGETS: Record<string, CoreProductRangeTargetResolver> = {
  ...
  characterAntiComb: (key) => [productParamTarget(KESSHO_PRODUCT_PARAM_IDS.FxDynamicsCharacterAntiComb, key)],
  characterDiffusion: (key) => [productParamTarget(KESSHO_PRODUCT_PARAM_IDS.FxDynamicsCharacterDiffusion, key)],
  ...
  degradeEventAmount: (key) => [productParamTarget(KESSHO_PRODUCT_PARAM_IDS.FxDynamicsDegradeEventAmount, key)],
  degradeProfileAmount: (key) => [productParamTarget(KESSHO_PRODUCT_PARAM_IDS.FxDynamicsDegradeProfileAmount, key)],
  degradeDitherAmount: (key) => [productParamTarget(KESSHO_PRODUCT_PARAM_IDS.FxDynamicsDegradeDitherAmount, key)],
