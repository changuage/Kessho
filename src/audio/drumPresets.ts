...
export const CLICK_PRESETS: DrumVoicePreset[] = [
  ...
  // --- New presets showcasing ExciterColor ---
  {
    name: 'Smooth Transient',
    voice: 'click',
    tags: ['exciter', 'smooth', 'hybrid'],
    params: {
      drumClickDecay: 8,
      drumClickFilter: 5000,
      drumClickTone: 0.4,
...
export const BEEP_HI_PRESETS: DrumVoicePreset[] = [
  ...
  // --- New presets showcasing FM Feedback, Mod Envelope, Noise Injection ---
  {
    name: 'FM Bell',
    voice: 'beepHi',
    tags: ['fm', 'bell', 'metallic', 'feedback'],
    params: {
      drumBeepHiFreq: 3000,
      drumBeepHiAttack: 0,
      drumBeepHiDecay: 200,
  ...
  },
  {
    ...
    voice: 'beepHi',
    tags: ['fm', 'percussive', 'transient', 'modenv'],
    params: {
      drumBeepHiFreq: 4500,
      drumBeepHiAttack: 0,
      drumBeepHiDecay: 60,
  ...
  },
  {
    name: 'Chaos Ring',
    voice: 'beepHi',
    tags: ['fm', 'feedback', 'chaos', 'experimental'],
    params: {
      drumBeepHiFreq: 2000,
      drumBeepHiAttack: 0,
      drumBeepHiDecay: 150,
  ...
  // ── Opal-inspired showcase presets ──
  {
    name: 'Tubular Bell',
    voice: 'beepHi',
    tags: ['opal', 'bell', 'ratio', 'harmonic'],
    params: {
      drumBeepHiFreq: 1200,
      drumBeepHiAttack: 1,
      drumBeepHiDecay: 400,
  ...
  },
  {
    ...
    voice: 'beepHi',
    tags: ['opal', 'phase', 'digital', 'stereo'],
    params: {
      drumBeepHiFreq: 3000,
      drumBeepHiAttack: 0,
      drumBeepHiDecay: 120,
...
export const BEEP_LO_PRESETS: DrumVoicePreset[] = [
  ...
  // --- New presets showcasing Modal Resonator Bank ---
  {
    name: 'Modal Bell',
    voice: 'beepLo',
    tags: ['modal', 'bell', 'resonant', 'metallic'],
    params: {
      drumBeepLoFreq: 300,
      drumBeepLoAttack: 0,
      drumBeepLoDecay: 400,
  ...
  },
  {
    name: 'Struck Bar',
    voice: 'beepLo',
    tags: ['modal', 'percussive', 'bar', 'marimba'],
    params: {
      drumBeepLoFreq: 440,
      drumBeepLoAttack: 0,
      drumBeepLoDecay: 200,
  ...
  },
  {
    name: 'Gamelan Tone',
    voice: 'beepLo',
    tags: ['modal', 'gamelan', 'metallic', 'inharmonic'],
    params: {
      drumBeepLoFreq: 350,
      drumBeepLoAttack: 0,
      drumBeepLoDecay: 600,
  ...
  },
  {
    name: 'Singing Metal',
    voice: 'beepLo',
    tags: ['modal', 'singing', 'sustain', 'ambient'],
    params: {
      drumBeepLoFreq: 250,
      drumBeepLoAttack: 2,
      drumBeepLoDecay: 800,
  ...
  // ── Opal-inspired spread/cut showcase presets ──
  {
    name: 'Spread Marimba',
    voice: 'beepLo',
    tags: ['opal', 'spread', 'marimba', 'warm'],
    params: {
      drumBeepLoFreq: 300,
      drumBeepLoAttack: 1,
      drumBeepLoDecay: 400,
...
export const NOISE_PRESETS: DrumVoicePreset[] = [
  ...
  // --- New presets showcasing Pulsar Particle Mode ---
  {
    name: 'Dust Particles',
    voice: 'noise',
    tags: ['particle', 'dust', 'sparse', 'minimal'],
    params: {
      drumNoiseFilterFreq: 10000,
      drumNoiseFilterQ: 1,
      drumNoiseFilterType: 'highpass',
  ...
  },
  {
    name: 'Grain Cloud',
    voice: 'noise',
    tags: ['particle', 'granular', 'cloud', 'texture'],
    params: {
      drumNoiseFilterFreq: 6000,
      drumNoiseFilterQ: 2,
      drumNoiseFilterType: 'bandpass',
  ...
  },
  {
    ...
    voice: 'noise',
    tags: ['particle', 'rain', 'random', 'ambient'],
    params: {
      drumNoiseFilterFreq: 8000,
      drumNoiseFilterQ: 1.5,
      drumNoiseFilterType: 'highpass',
  ...
  },
  {
    name: 'Micro Scatter',
    voice: 'noise',
    tags: ['particle', 'scatter', 'fast', 'percussive'],
    params: {
  ...
  // ── Opal-inspired ratchet & particle randomization showcase presets ──
  {
    name: '808 Clap',
    voice: 'noise',
    tags: ['opal', 'ratchet', 'clap', 'classic'],
    params: {
      drumNoiseFilterFreq: 3000,
      drumNoiseFilterQ: 1.5,
      drumNoiseFilterType: 'bandpass',
  ...
  },
  {
    name: 'Ratchet Burst',
    voice: 'noise',
    tags: ['opal', 'ratchet', 'burst', 'percussive'],
    params: {
      drumNoiseFilterFreq: 8000,
      drumNoiseFilterQ: 0.8,
      drumNoiseFilterType: 'highpass',
  ...
  },
  {
    name: 'Jittery Dust',
    voice: 'noise',
    tags: ['opal', 'particle', 'random', 'dust'],
    params: {
      drumNoiseFilterFreq: 10000,
      drumNoiseFilterQ: 1,
      drumNoiseFilterType: 'highpass',
  ...
  },
  {
    ...
    voice: 'noise',
    tags: ['opal', 'particle', 'random', 'chaos'],
    params: {
  ...
  },
  {
    name: 'Ratchet Rain',
    voice: 'noise',
    tags: ['opal', 'ratchet', 'particle', 'random', 'rain'],
    params: {
