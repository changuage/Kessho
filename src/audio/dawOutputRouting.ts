...
export const DAW_OUTPUT_SOURCE_DEFS = [
  ...
  { sourceId: 'sample1', label: STEM_RECORD_TRACK_LABELS.sample1, tapId: CORE_PRODUCT_GRAPH_TAP_IDS.sample1Dry },
  { sourceId: 'sample2', label: STEM_RECORD_TRACK_LABELS.sample2, tapId: CORE_PRODUCT_GRAPH_TAP_IDS.sample2Dry },
