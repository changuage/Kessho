...
const SOURCE_CONFIGS: SourceConfig[] = [
  ...
  },
  {
    ...
    enabled: (state) => !!state.sample1Enabled,
    score: (state) => numericState(state, 'sample1Level'),
    reverbKey: 'sample1ReverbSend',
    delayAKey: 'sample1DelayASend',
    delayBKey: 'sample1DelayBSend',
    granularKey: 'granularSample1Send',
  },
  {
    id: 'drums',
    label: 'Drums',
...
const DEMO_SOURCES: Record<Exclude<PrototypeScenario, 'live'>, SourceVisual[]> = {
  ...
  dense: [
    ...
    demoSource({ id: 'sample1', label: 'Sample 1', family: 'lead', color: SOURCE_COLORS.sample1, score: 0.4, authoredNorm: 0.42, mode: 'sampleHold', rangeNorm: { min: 0.12, max: 0.52 }, reverb: 0.36, delayA: 0.12, delayB: 0.28, granular: 0.05 }),
