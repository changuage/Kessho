...
import { SnowflakePresetLoader } from './SnowflakePresetLoader';
      ...
      <div style={{
        ...
        {isRecording ? (
          ...
          <SnowflakePresetLoader
            ...
            onLoadJourneyPreset={onLoadJourneyPreset}
            buttonStyle={{ ...styles.advancedButton, color: 'rgba(255,255,255,0.6)' }}
            popupTop={Math.max(58, playButtonTop + 50)}
            disableBlur={disablePresetPopupBlur}
          />
        )}
      </div>
