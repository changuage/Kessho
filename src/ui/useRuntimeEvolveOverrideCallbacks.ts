...
type UseRuntimeEvolveOverrideCallbacksOptions = {
  activeTab: string;
  ...
  setDrumEvolveOverridesChangedCallback: (callback: EvolveOverrideCallback | null) => void;
  setSynthEvolveOverridesChangedCallback: (callback: EvolveOverrideCallback | null) => void;
  setSynthNoteRangeEvolvedCallback: (callback: SynthNoteRangeCallback | null) => void;
};

type RuntimeEvolveOverrideState = {
...
export function useRuntimeEvolveOverrideCallbacks({
  activeTab,
...
}: UseRuntimeEvolveOverrideCallbacksOptions): RuntimeEvolveOverrideState {
  ...
  useEffect(() => {
    setDrumEvolveOverridesChangedCallback((laneIndex, overrides) => {
    ...
    return () => {
      setDrumEvolveOverridesChangedCallback(null);
    };
  }, [
    activeTab,
    createDefaultPitchSettings,
  ...
  useEffect(() => {
    setSynthEvolveOverridesChangedCallback((laneIndex, overrides) => {
    ...
    return () => {
      setSynthEvolveOverridesChangedCallback(null);
    };
  }, [
    activeTab,
    createDefaultPitchSettings,
  ...
  useEffect(() => {
    setSynthNoteRangeEvolvedCallback((laneIndex, noteMin, noteMax) => {
      mergeRuntimeValues({
    ...
    return () => {
      setSynthNoteRangeEvolvedCallback(null);
    };
  }, [setSynthNoteRangeEvolvedCallback]);
