...
const styles = {
  root: {
    display: 'grid',
    gridTemplateColumns: `repeat(${AUDIO_ENGINE_SWITCH_COLUMN_COUNT}, minmax(0, 1fr))`,
    width: 'min(270px, 100%)',
    minHeight: '36px',
    overflow: 'hidden',
