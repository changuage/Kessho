...
Generated: 2026-05-07T17:58:09.976Z
...
| --- | --- | ---: | --- |
| PASS | Acceptance corpus contract | 46ms | `node scripts/profile-kessho-core-acceptance-corpus.mjs --json` |
| PASS | Browser corpus URL | 24ms | `node -e 'fetch(process.argv[1]).then((response)=>{console.log("HTTP " + response.status); process.exit(response.ok ? 0 : 1);}).catch((error)=>{console.error(error); process.exit(1);})' http://127.0.0.1:4173/` |
...
| --- | --- | --- | ---: | --- |
| PASS | module | Pad module parity | 55ms | `node scripts/check-kessho-core-pad-module-parity.mjs` |
...
| Status | Kind | Check | Duration | Rerun / Reason |
| --- | --- | --- | ---: | --- |
| PASS | module | Dynamics module parity | 60ms | `node scripts/check-kessho-core-dynamics-module-parity.mjs` |
| PASS | module | Reverb module parity | 185ms | `node scripts/check-kessho-core-reverb-module-parity.mjs` |
| PASS | module | Granular module parity | 55ms | `node scripts/check-kessho-core-granular-module-parity.mjs` |
| PASS | module | Spectral freeze module parity | 63ms | `node scripts/check-kessho-core-spectral-freeze-module-parity.mjs` |
| PASS | module | Delay A module regression | 53ms | `node scripts/check-kessho-core-delay-a-module-regression.mjs` |
...
| PASS | corpus (required) | pad-delay-reverb-bloom: Pad delay into reverb bloom | 22.3s | `node scripts/profile-kessho-core-acceptance-corpus.mjs --run --case=pad-delay-reverb-bloom --url=http://127.0.0.1:4173/` |
| PASS | corpus (required) | granular-pad-cloud: Pad-fed granular cloud | 25.4s | `node scripts/profile-kessho-core-acceptance-corpus.mjs --run --case=granular-pad-cloud --url=http://127.0.0.1:4173/` |
| PASS | corpus (required) | granular-delay-return: Delay returns through granular | 25.5s | `node scripts/profile-kessho-core-acceptance-corpus.mjs --run --case=granular-delay-return --url=http://127.0.0.1:4173/` |
| PASS | corpus (required) | dynamics-master-chain: Pad through dynamics and master chain | 22.3s | `node scripts/profile-kessho-core-acceptance-corpus.mjs --run --case=dynamics-master-chain --url=http://127.0.0.1:4173/` |
...
| Status | Kind | Check | Duration | Rerun / Reason |
| --- | --- | --- | ---: | --- |
| PASS | module | Lead FM module parity | 47ms | `node scripts/check-kessho-core-lead-fm-module-parity.mjs` |
| PASS | module | Drum module parity | 47ms | `node scripts/check-kessho-core-drum-module-parity.mjs` |
| PASS | module | Soundscapes module parity | 175ms | `node scripts/check-kessho-core-soundscapes-module-parity.mjs` |
| PASS | module | Core MIDI event contract | 155ms | `node scripts/check-core-midi-events.mjs` |
| PASS | corpus (required) | lead-manual-dry: Manual dry lead | 13.4s | `node scripts/profile-kessho-core-acceptance-corpus.mjs --run --case=lead-manual-dry --url=http://127.0.0.1:4173/` |
...
| PASS | corpus (required) | drum-delay-dub: Dubbed-out drum delay | 22.0s | `node scripts/profile-kessho-core-acceptance-corpus.mjs --run --case=drum-delay-dub --url=http://127.0.0.1:4173/` |
...
| Status | Kind | Check | Duration | Rerun / Reason |
| --- | --- | --- | ---: | --- |
| PASS | module | Core snapshot contract | 170ms | `node scripts/check-core-snapshot-contract.mjs` |
...
| PASS | corpus (required) | full-mix-gamelan: Gamelan full mix | 32.2s | `node scripts/profile-kessho-core-acceptance-corpus.mjs --run --case=full-mix-gamelan --url=http://127.0.0.1:4173/` |
