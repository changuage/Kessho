...
| `./coreProductSnapshot` | Product snapshot serializer | Web Product host | CANONICAL_GENERATED_SCHEMA_HELPER | C++ Product snapshot loader | Split further; keep only generated serialization | Cleanup |
