...
| Broader Lead preset probes pass | BLOCKED | audio-render, browser/worklet | `core:product:source-parity`, focused `lead-manual-dry`, `lead1-gamelan-dry`, `lead1-soft-rhodes-dry`, `lead-delay-heavy`, `lead2-gamelan-dry`, and `lead2-soft-rhodes-dry` browser probes | broader web-vs-Product Lead preset parity still needs completion before default promotion |
