...
public extension KesshoNativeBridgePolicy {
    static let defaultKesshoPolicy = KesshoNativeBridgePolicy(methodsByPlugin: [
        ...
        "KesshoAudioSession": [
            ...
            KesshoNativeBridgeMethodPolicy(method: "prepareNativeProductRuntime", maxOptionsBytes: 256),
            KesshoNativeBridgeMethodPolicy(method: "loadNativeProductSnapshot", maxOptionsBytes: 256 * 1024),
            KesshoNativeBridgeMethodPolicy(method: "enqueueNativeProductEvents", maxOptionsBytes: 64 * 1024),
            KesshoNativeBridgeMethodPolicy(method: "registerNativeProductFileAsset", maxOptionsBytes: 8 * 1024),
            KesshoNativeBridgeMethodPolicy(method: "registerNativeProductDecodedAsset", maxOptionsBytes: 128 * 1024 * 1024),
            KesshoNativeBridgeMethodPolicy(method: "unregisterNativeProductAsset", maxOptionsBytes: 1024),
            KesshoNativeBridgeMethodPolicy(method: "resetNativeProductRuntime", maxOptionsBytes: 256),
            KesshoNativeBridgeMethodPolicy(method: "startNativeProductRuntime", maxOptionsBytes: 256),
            KesshoNativeBridgeMethodPolicy(method: "stopNativeProductRuntime", maxOptionsBytes: 256),
            KesshoNativeBridgeMethodPolicy(method: "getNativeProductTelemetry", maxOptionsBytes: 256),
            KesshoNativeBridgeMethodPolicy(method: "setNativeProductInteractionDemand", maxOptionsBytes: 1024),
